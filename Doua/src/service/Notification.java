...
public class Notification {
    ...
    private static void Playsound() {
        ...
        if (random == 1) {//Rose
            GRADIENT = "-fx-background-color:  linear-gradient(to right top, #f2709c , #ff9472);";
        }
        if (random == 2) {//azre9
            GRADIENT = "-fx-background-color:  linear-gradient(to right top, #56CCF2 , #2F80ED);";
        }
        if (random == 3) {//orangé
            GRADIENT = "-fx-background-color:  linear-gradient(to right top, #FDC830 , #F37335);";
        }
        if (random == 4) {//violet
            GRADIENT = "-fx-background-color:  linear-gradient(to right top, #DA4453 , #89216B);";
        }
        if (random == 5) {//Dark Green
            GRADIENT = "-fx-background-color:  linear-gradient(to right top, #136a8a , #267871);";
        }
        if (random == 6) {//Dark blue
            GRADIENT = "-fx-background-color: linear-gradient(to right, #1e3c72 0%, #2a5298  51%, #1e3c72  100%);";
        }
        if (random == 7) {//orangé foncé
            GRADIENT = "-fx-background-color:  linear-gradient(to right, #FFD3A5 10%, #FD6585 100%);";
        }
        if (random == 8) {//Black
            GRADIENT = "-fx-background-color: linear-gradient(to bottom, #485461 0%, #28313b 74%);";
        }
        if (random == 9) {//Yellow
            GRADIENT = "-fx-background-color: linear-gradient(to bottom, #4776E6 0%, #8E54E9 74%);";
        }
        if (random == 10) {//Green
            GRADIENT = "-fx-background-color: linear-gradient(to right top, #11998e 0%, #38ef7d 100%);";
        }
